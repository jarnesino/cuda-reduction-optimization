...
void reduce7(const int implementationNumber, reduceImplementationFunction implementation, const int reductionsPerIteration, int *inputData, const int dataSize, cudaEvent_t startEvent, cudaEvent_t stopEvent);
